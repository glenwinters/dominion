...
public class TraderCard extends DominionCard
{
    public TraderCard()
    {
        super( "Trader", 4, 0, EnumSet.of( DominionCard.CardType.ACTION, DominionCard.CardType.REACTION ),
    ...
    public void onPlay( DominionGame game )
    {
        ...
        DominionCard cardToTrash = currentPlayer.promptToChooseOneCard( currentPlayer.getHand(), 
                "Choose a card to trash", false );
        if( cardToTrash != null )
        {
